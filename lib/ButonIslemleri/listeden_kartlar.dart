...
class ListedenKartlar extends StatefulWidget {
  const ListedenKartlar({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _ListedenKartlar();
}

class _ListedenKartlar extends State<ListedenKartlar> {
  bool isveri = false;
  int? _index = 0;
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (_, i) {
                        return Transform.scale(
                            ...
                            child: Animasyon(kelimeler![i].sira!,bolum: kelimeler![i].bolumadi,seviye:kelimeler![i].bolum??0));
                      },
                    ),
                  ),
                ),
            ...
            child: Container(
              ...
              child: Column(
                  ...
                  children: const [
                    ...
                    Text(
                      "Listelerime Eklenmiş Kelime Yok",
