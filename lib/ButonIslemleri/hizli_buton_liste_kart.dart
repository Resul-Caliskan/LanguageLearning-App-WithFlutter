...
class HizliTestListe extends StatefulWidget {
  double height = 10;
  double width = 10;

  HizliTestListe({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _HizliTestListe();
}

class _HizliTestListe extends State<HizliTestListe> {
...
// burda tebrik widget ı gösterilip Future.delayed ile 900 ms sonra diğer kelimeye geçiliyor
  void guncelle() {
    ...
    Future.delayed(const Duration(milliseconds: 1100), () {
      setState(() {
        db.silVeri(kelimeler![counter].bolumadi!, kelimeler![counter].bolum!,
  ...
  void initState() {
    ...
    liste.then((value) {
      if (value.isEmpty) {
        ...
        cardlist = cardGetir(count,kelimeler![counter].bolum ?? 0);
        hedefList = hedefGetir(count,kelimeler![counter].bolum ?? 0);
      }
    });
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              kelimeler![counter].bolumadi ==
                                                      "isimler"
                                                  ? isimler[kelimeler![counter].bolum!-1]["data"]
                                                          [kelimeler![counter].sira]
                                                      ["ingilizceKelime"]
                                                  : kelimeler![counter].bolumadi ==
                                                          "fiiller"
                                                      ? fiiller[kelimeler![counter].bolum!-1]["data"]
                                                              [kelimeler![counter].sira]
                                                          ["ingilizceKelime"]
                                                      : kelimeler![counter]
                                                                  .bolumadi ==
                                                              "zarflar"
                                                          ? zarflar[kelimeler![counter].bolum!-1 ]["data"]
                                                                  [kelimeler![counter].sira]
                                                              [
                                                              "ingilizceKelime"]
                                                          : sifatlar[kelimeler![counter].bolum!-1 ]["data"]
                                                                  [kelimeler![counter].sira]
                                                              ["ingilizceKelime"],
